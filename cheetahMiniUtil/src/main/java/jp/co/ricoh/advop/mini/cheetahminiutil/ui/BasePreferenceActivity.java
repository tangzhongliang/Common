...
public class BasePreferenceActivity extends PreferenceActivity implements ActivityInterface {
    private final static String TAG = BasePreferenceActivity.class.getSimpleName();
